...
//TERMINAL const
const TERMINAL_VERSION = "1.0.0-addon" // terminal version, duh.
//css & html element relations:
const TERMINAL_BACKGROUND_ID = "addon-terminal-background"; // blurred background div id, contains it all, hides it all.
const TERMINAL_CONTAINER_ID = "addon-terminal-container"; // container div id for all the terminal elements below.
const TERMINAL_OUTPUT_ID = "addon-terminal-output"; // the id from the <pre> tag where we will to print to.
const TERMINAL_FORM_ID = "addon-terminal-form"; // <form> id.
const TERMINAL_INPUT_ID = "addon-terminal-input"; // <input type text> id.
const TERMINAL_BUTTON_DOWN_ID = "addon-terminal-down"; // <button>x</> id.
const TERMINAL_BUTTON_UP_ID = "addon-terminal-up"; // <button>x</> id.
const TERMINAL_BUTTON_CLOSE_ID = "addon-terminal-close"; // <button>x</> id.
const TERMINAL_VISIBLE_CLASS = "addon-terminal-visible"; // the class that (by default) hides the terminal when set to the terminal-background div.
...
const TERMINAL_AUTO_INSERT_CSS = false; // when true: automaticly inserts a stylesheet-link in the html.head
...
const TERMINAL_KEY_OPEN_CTRL = true; // When true: ctrl-key must be pressed together with TERMINAL_KEY_OPEN.
